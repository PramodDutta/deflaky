      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-card-border bg-card-bg p-8">
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full flex items-center justify-center gap-3 border border-card-border rounded-lg py-2.5 text-sm font-medium hover:bg-card-border/30 transition">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-card-border rounded-lg bg-card-border/30 px-4 py-2.5 text-sm focus:outline-none focus:border-accent transition"
              />
            </div>
            <div>
            ...
            <button className="w-full bg-accent hover:bg-accent-hover text-black font-semibold py-2.5 rounded-lg transition">
              Sign in
            </button>
          </div>
        </div>
